...
public final class MecanumDrive {
    public static class Params {
        ...
        public double kV = 0.3 ; //  0.1954150293150322;
        ...
        public double axialGain = 6 ;  // x (forward/backward)  12
        public double lateralGain = 6 ;  //                     45
        public double headingGain = 6 ; // shared with turn   20

        public double axialVelGain = 0.3 ;  //                  1
        public double lateralVelGain = 0.3 ;  //                6
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        //   leftFront.setDirection(DcMotorSimple.Direction.REVERSE);
        //rightFront.setDirection(DcMotorSimple.Direction.REVERSE);  // Erasmus Old ??
        //rightBack.setDirection(DcMotorSimple.Direction.REVERSE);
        leftFront.setDirection(DcMotorSimple.Direction.REVERSE);  // Erasmus
